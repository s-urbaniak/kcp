	...
	var testCases = []struct {
		...
		},
		{
			...
			work: func(ctx context.Context, t *testing.T, server runningServer) {
				...
				framework.AdmitNewWorkspaceAccess(t, ctx, kubeClusterClient, universal, []string{"user-1"}, nil, []string{"access"})
				...
				// TODO (p0lyn0mila): check if it is safe to remove the following RBAC
				/*
					cr, crb = createClusterRoleAndBindings(
